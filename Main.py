...
class Game:
    def __init__(self):
        ...
        print("Player N: ", self.networkPlayer)
        self.setup_player()
    ...
    def setup_player(self):
        ...
        self.player.selected_folder = self.player.animations_names[self.networkPlayer.anim_folder]
    ...
    def update_other_player(self):
        PLAYERS_CONNECTED = self.network.send(self.networkPlayer)
        ...
        if PLAYERS_CONNECTED:
            for player_index in PLAYERS_CONNECTED:
                ...
                new_player.selected_folder = new_player.animations_names[player_to_draw.anim_folder]
